...
//     // scenario perturbation
//     auto param = this->perturb[this->scenario_name];
...
//     mc::FFVar g_1_0 = X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[1]"]] + X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[2]"]] + X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[3]"]] + X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[4]"]] + X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[5]"]] + X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[6]"]] + X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[7]"]] + X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[8]"]] + X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[9]"]] + X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[10]"]] + X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_CGO"]]-125;
//     mc::FFVar g_1_1 = 0.08 * X[n_first_stage_vars + this->second_stage_map["flow_Reformer95"]] + 
//         0.09 * X[n_first_stage_vars + this->second_stage_map["flow_Reformer100"]] + 
//         0.015 * X[n_first_stage_vars + this->second_stage_map["flow_Cracker_Mogas"]] + 
//         0.012 * X[n_first_stage_vars + this->second_stage_map["flow_Cracker_AGO"]] + 
//         0.03 * X[n_first_stage_vars + this->second_stage_map["flow_Isomerisation"]] + 
//         0.04 * X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_CGO"]] - 
//         X[n_first_stage_vars + this->second_stage_map["flow_Burn[1]"]] + 
        
//         params[0] * X[this->first_stage_map["CrudeQuantity[1]"]] + 
//         0.02 * X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[1]"]] + 
//         params[1] * X[this->first_stage_map["CrudeQuantity[2]"]] + 
//         0.02 * X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[2]"]] + 
//         params[2] * X[this->first_stage_map["CrudeQuantity[3]"]] + 
//         0.02 * X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[3]"]] + 
//         params[3] * X[this->first_stage_map["CrudeQuantity[4]"]] + 
//         0.02 * X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[4]"]] + 
//         params[4] * X[this->first_stage_map["CrudeQuantity[5]"]] + 
//         0.02 * X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[5]"]] + 
//         params[5] * X[this->first_stage_map["CrudeQuantity[6]"]] + 
//         0.03 * X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[6]"]] + 
//         params[6] * X[this->first_stage_map["CrudeQuantity[7]"]] + 
//         0.03 * X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[7]"]] + 
//         params[7] * X[this->first_stage_map["CrudeQuantity[8]"]] + 
//         0.04 * X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[8]"]] + 
//         params[8] * X[this->first_stage_map["CrudeQuantity[9]"]] + 
//         0.02 * X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[9]"]] + 
//         params[9] * X[this->first_stage_map["CrudeQuantity[10]"]] + 
//         0.04 * X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[10]"]];
//     mc::FFVar n_g_1_1 =-g_1_1;
//     mc::FFVar g_1_2 = 
//         0.09 * X[n_first_stage_vars + this->second_stage_map["flow_Reformer95"]] + 
//         0.12 * X[n_first_stage_vars + this->second_stage_map["flow_Reformer100"]] + 
//         0.053 * X[n_first_stage_vars + this->second_stage_map["flow_Cracker_Mogas"]] + 
//         0.046 * X[n_first_stage_vars + this->second_stage_map["flow_Cracker_AGO"]] - 
//         X[n_first_stage_vars + this->second_stage_map["flow_LG_producing"]] - 
//         X[n_first_stage_vars + this->second_stage_map["flow_PG98[1]"]] - 
//         X[n_first_stage_vars + this->second_stage_map["flow_ES95[1]"]] - 
//         X[n_first_stage_vars + this->second_stage_map["flow_Burn[2]"]] + 
        
//         params[10] * X[this->first_stage_map["CrudeQuantity[1]"]] + 
//         params[11] * X[this->first_stage_map["CrudeQuantity[2]"]] + 
//         params[12] * X[this->first_stage_map["CrudeQuantity[3]"]] + 
//         params[13] * X[this->first_stage_map["CrudeQuantity[4]"]] + 
//         params[14] * X[this->first_stage_map["CrudeQuantity[5]"]] + 
//         params[15] * X[this->first_stage_map["CrudeQuantity[6]"]] + 
//         params[16] * X[this->first_stage_map["CrudeQuantity[7]"]] + 
//         params[17] * X[this->first_stage_map["CrudeQuantity[8]"]] + 
//         params[18] * X[this->first_stage_map["CrudeQuantity[9]"]] + 
//         params[19] * X[this->first_stage_map["CrudeQuantity[10]"]];
//     mc::FFVar n_g_1_2 = - g_1_2;
//     mc::FFVar g_1_3 = 
//         -X[n_first_stage_vars + this->second_stage_map["flow_LN_producing"]] - 
//         X[n_first_stage_vars + this->second_stage_map["flow_Burn[3]"]] - 
//         X[n_first_stage_vars + this->second_stage_map["flow_PG98[3]"]] - 
//         X[n_first_stage_vars + this->second_stage_map["flow_ES95[3]"]] - 
//         X[n_first_stage_vars + this->second_stage_map["flow_Isomerisation"]] - 
//         0.05 * X[n_first_stage_vars + this->second_stage_map["flow_JPF[1]"]] - 
//         0.035 * X[n_first_stage_vars + this->second_stage_map["flow_JPF[2]"]] + 
        
//         params[20] * X[this->first_stage_map["CrudeQuantity[1]"]] + 
//         params[21] * X[this->first_stage_map["CrudeQuantity[2]"]] + 
//         params[22] * X[this->first_stage_map["CrudeQuantity[3]"]] + 
//         params[23] * X[this->first_stage_map["CrudeQuantity[4]"]] + 
//         params[24] * X[this->first_stage_map["CrudeQuantity[5]"]] + 
//         params[25] * X[this->first_stage_map["CrudeQuantity[6]"]] + 
//         params[26] * X[this->first_stage_map["CrudeQuantity[7]"]] + 
//         params[27] * X[this->first_stage_map["CrudeQuantity[8]"]] + 
//         params[28] * X[this->first_stage_map["CrudeQuantity[9]"]] + 
//         params[29] * X[this->first_stage_map["CrudeQuantity[10]"]];
//     mc::FFVar n_g_1_3 = - g_1_3;
//     mc::FFVar g_1_4 = 
//         -0.1 * X[n_first_stage_vars + this->second_stage_map["flow_JPF[1]"]] - 
//         0.065 * X[n_first_stage_vars + this->second_stage_map["flow_JPF[2]"]] - 
//         X[n_first_stage_vars + this->second_stage_map["flow_Reformer95"]] - 
//         X[n_first_stage_vars + this->second_stage_map["flow_Reformer100"]] + 
        
//         params[30] * X[this->first_stage_map["CrudeQuantity[1]"]] + 
//         params[31] * X[this->first_stage_map["CrudeQuantity[2]"]] + 
//         params[32] * X[this->first_stage_map["CrudeQuantity[3]"]] + 
//         params[33] * X[this->first_stage_map["CrudeQuantity[4]"]] + 
//         params[34] * X[this->first_stage_map["CrudeQuantity[5]"]] + 
//         params[35] * X[this->first_stage_map["CrudeQuantity[6]"]] + 
//         params[36] * X[this->first_stage_map["CrudeQuantity[7]"]] + 
//         params[37] * X[this->first_stage_map["CrudeQuantity[8]"]] + 
//         params[38] * X[this->first_stage_map["CrudeQuantity[9]"]] + 
//         params[39] * X[this->first_stage_map["CrudeQuantity[10]"]];
//     mc::FFVar n_g_1_4 = - g_1_4;
//     mc::FFVar g_1_5 = 
//         -0.85 * X[n_first_stage_vars + this->second_stage_map["flow_JPF[1]"]] - 
//         0.9 * X[n_first_stage_vars + this->second_stage_map["flow_JPF[2]"]] - 
//         X[n_first_stage_vars + this->second_stage_map["flow_AGO_3[1]"]] + 
        
//         params[40] * X[this->first_stage_map["CrudeQuantity[1]"]] + 
//         params[41] * X[this->first_stage_map["CrudeQuantity[2]"]] + 
//         params[42] * X[this->first_stage_map["CrudeQuantity[3]"]] + 
//         params[43] * X[this->first_stage_map["CrudeQuantity[4]"]] + 
//         params[44] * X[this->first_stage_map["CrudeQuantity[5]"]] + 
//         params[45] * X[this->first_stage_map["CrudeQuantity[6]"]] + 
//         params[46] * X[this->first_stage_map["CrudeQuantity[7]"]] + 
//         params[47] * X[this->first_stage_map["CrudeQuantity[8]"]] + 
//         params[48] * X[this->first_stage_map["CrudeQuantity[9]"]] + 
//         params[49] * X[this->first_stage_map["CrudeQuantity[10]"]];
//     mc::FFVar n_g_1_5= - g_1_5;
//     mc::FFVar g_1_6 = 
//         -X[n_first_stage_vars + this->second_stage_map["flow_Cracker_Mogas"]] - 
//         X[n_first_stage_vars + this->second_stage_map["flow_Cracker_AGO"]] + 
        
//         params[50] * X[this->first_stage_map["CrudeQuantity[1]"]] + 
//         params[51] * X[this->first_stage_map["CrudeQuantity[2]"]] + 
//         params[52] * X[this->first_stage_map["CrudeQuantity[3]"]] + 
//         params[53] * X[this->first_stage_map["CrudeQuantity[4]"]] + 
//         params[54] * X[this->first_stage_map["CrudeQuantity[5]"]] + 
//         params[55] * X[this->first_stage_map["CrudeQuantity[6]"]] + 
//         params[56] * X[this->first_stage_map["CrudeQuantity[7]"]] + 
//         params[57] * X[this->first_stage_map["CrudeQuantity[8]"]] + 
//         params[58] * X[this->first_stage_map["CrudeQuantity[9]"]] + 
//         params[59] * X[this->first_stage_map["CrudeQuantity[10]"]];
//     mc::FFVar n_g_1_6 = - g_1_6;
//     mc::FFVar g_1_7  = -X[n_first_stage_vars + this->second_stage_map["flow_AGO_1[1]"]] - X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[1]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_3[1]"]] + params[60] * X[this->first_stage_map["CrudeQuantity[1]"]];
//     mc::FFVar g_1_8  = -X[n_first_stage_vars + this->second_stage_map["flow_AGO_1[2]"]] - X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[2]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_3[2]"]] + params[61] * X[this->first_stage_map["CrudeQuantity[2]"]];
//     mc::FFVar g_1_9  = -X[n_first_stage_vars + this->second_stage_map["flow_AGO_1[3]"]] - X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[3]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_3[3]"]] + params[62] * X[this->first_stage_map["CrudeQuantity[3]"]];
//     mc::FFVar g_1_10 = -X[n_first_stage_vars + this->second_stage_map["flow_AGO_1[4]"]] - X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[4]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_3[4]"]] + params[63] * X[this->first_stage_map["CrudeQuantity[4]"]];
//     mc::FFVar g_1_11 = -X[n_first_stage_vars + this->second_stage_map["flow_AGO_1[5]"]] - X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[5]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_3[5]"]] + params[64] * X[this->first_stage_map["CrudeQuantity[5]"]];
//     mc::FFVar g_1_12 = -X[n_first_stage_vars + this->second_stage_map["flow_AGO_1[6]"]] - X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[6]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_3[6]"]] + params[65] * X[this->first_stage_map["CrudeQuantity[6]"]];
//     mc::FFVar g_1_13 = -X[n_first_stage_vars + this->second_stage_map["flow_AGO_1[7]"]] - X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[7]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_3[7]"]] + params[66] * X[this->first_stage_map["CrudeQuantity[7]"]];
//     mc::FFVar g_1_14 = -X[n_first_stage_vars + this->second_stage_map["flow_AGO_1[8]"]] - X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[8]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_3[8]"]] + params[67] * X[this->first_stage_map["CrudeQuantity[8]"]];
//     mc::FFVar g_1_15 = -X[n_first_stage_vars + this->second_stage_map["flow_AGO_1[9]"]] - X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[9]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_3[9]"]] + params[68] * X[this->first_stage_map["CrudeQuantity[9]"]];
//     mc::FFVar g_1_16 = -X[n_first_stage_vars + this->second_stage_map["flow_AGO_1[10]"]] - X[n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[10]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_3[10]"]] + params[69] * X[this->first_stage_map["CrudeQuantity[10]"]];
//     mc::FFVar n_g_1_7 = - g_1_7;
//     mc::FFVar n_g_1_8 = - g_1_8;
//     mc::FFVar n_g_1_9 = - g_1_9;
//     mc::FFVar n_g_1_10 = - g_1_10;
...
//     mc::FFVar n_g_1_15 = - g_1_15;
//     mc::FFVar n_g_1_16 = - g_1_16;
//     mc::FFVar g_1_17 = params[70] * X[this->first_stage_map["CrudeQuantity[1]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_1[1]"]];
//     mc::FFVar g_1_18 = params[71] * X[this->first_stage_map["CrudeQuantity[2]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_1[2]"]];
//     mc::FFVar g_1_19 = params[72] * X[this->first_stage_map["CrudeQuantity[3]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_1[3]"]];
//     mc::FFVar g_1_20 = params[73] * X[this->first_stage_map["CrudeQuantity[4]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_1[4]"]];
//     mc::FFVar g_1_21 = params[74] * X[this->first_stage_map["CrudeQuantity[5]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_1[5]"]];
//     mc::FFVar g_1_22 = params[75] * X[this->first_stage_map["CrudeQuantity[6]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_1[6]"]];
//     mc::FFVar g_1_23 = params[76] * X[this->first_stage_map["CrudeQuantity[7]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_1[7]"]];
//     mc::FFVar g_1_24 = params[77] * X[this->first_stage_map["CrudeQuantity[8]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_1[8]"]];
//     mc::FFVar g_1_25 = params[78] * X[this->first_stage_map["CrudeQuantity[9]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_1[9]"]];
//     mc::FFVar g_1_26 = params[79] * X[this->first_stage_map["CrudeQuantity[10]"]] - X[n_first_stage_vars + this->second_stage_map["flow_HF_1[10]"]];
//     mc::FFVar n_g_1_17 = - g_1_17;
//     mc::FFVar n_g_1_18 = - g_1_18;
//     mc::FFVar n_g_1_19 = - g_1_19;
//     mc::FFVar n_g_1_20 = - g_1_20;
...
//     mc::FFVar g_1_74 = 
//         X[n_first_stage_vars + this->second_stage_map["blin_CDU_LG[1]"]] + 
//         X[n_first_stage_vars + this->second_stage_map["blin_CDU_LG[2]"]] + 
//         X[n_first_stage_vars + this->second_stage_map["blin_CDU_LG[3]"]] + 
//         X[n_first_stage_vars + this->second_stage_map["blin_CDU_LG[4]"]] - (
//             params[10] * X[this->first_stage_map["CrudeQuantity[1]"]] + 
//             params[11] * X[this->first_stage_map["CrudeQuantity[2]"]] + 
//             params[12] * X[this->first_stage_map["CrudeQuantity[3]"]] + 
//             params[13] * X[this->first_stage_map["CrudeQuantity[4]"]] + 
...
//             grbmodel->addVar(-GRB_INFINITY, 0.0001, 0.0, GRB_CONTINUOUS, ("AUX_" + std::to_string(i)));
