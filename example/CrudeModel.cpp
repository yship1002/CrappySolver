...
void CrudeModel::buildDAG() {
    for (auto& scenario_name : this->scenario_names) {
        ...
        mc::FFVar g_0_16 = this->X[scenario_name][this->first_stage_map["CrudeQuantity[6]"]]-222.1383147853736*this->X[scneario_name][this->first_stage_map["pickCrude[6]"]];
        ...
        mc::FFVar g_1_0 = [n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[1]"]] + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[2]"]] + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[3]"]] + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[4]"]] + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[5]"]] + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[6]"]] + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[7]"]] + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[8]"]] + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[9]"]] + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_1[10]"]] + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_CGO"]]-125;
        ...
        mc::FFVar objective=this->probability * (
            /* global flows (t = 1) */
            3.2 * this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Cracker_Mogas"]]
            + 3.0 * this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Cracker_AGO"]]
            + 2.7 * this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Reformer95"]]
            + 3.2 * this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Reformer100"]]
            + 6.0 * this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Isomerisation"]]
            + 3.345671410129097 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_Desulphurisation_CGO"]]

            - 561.6 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_LG_producing"]]
            - 1003.0 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_LN_producing"]]
            - 637.0 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_HF_2"]]
            ...
            - 907.0 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_AGO_2[1]"]]
            - 637.0 *
            ...
            + 864.3999526122498 *
                this->X[scenario_name][this->first_stage_map["CrudeQuantity[1]"]]
            ...
            - 907.0 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_AGO_2[2]"]]
            - 637.0 *
            ...
            - 907.0 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_AGO_2[3]"]]
            - 637.0 *
            ...
            + 824.9058168463453 *
                this->X[scenario_name][this->first_stage_map["CrudeQuantity[3]"]]
            ...
            - 907.0 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_AGO_2[4]"]]
            - 637.0 *
            ...
            + 839.5184609869758 *
                this->X[scenario_name][this->first_stage_map["CrudeQuantity[4]"]]
            ...
            - 907.0 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_AGO_2[5]"]]
            - 637.0 *
            ...
            + 779.3929097293013 *
                this->X[scenario_name][this->first_stage_map["CrudeQuantity[5]"]]
            ...
            - 907.0 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_AGO_2[6]"]]
            - 637.0 *
            ...
            + 692.8115942028985 *
                this->X[scenario_name][this->first_stage_map["CrudeQuantity[6]"]]
            ...
            - 907.0 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_AGO_2[7]"]]
            - 637.0 *
            ...
            + 878.862094037809 *
                this->X[scenario_name][this->first_stage_map["CrudeQuantity[7]"]]
            ...
            - 907.0 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_AGO_2[8]"]]
            - 637.0 *
            ...
            + 735.8113207547168 *
                this->X[scenario_name][this->first_stage_map["CrudeQuantity[8]"]]
            ...
            - 907.0 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_AGO_2[9]"]]
            - 637.0 *
            ...
            - 907.0 *
                this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_AGO_2[10]"]]
            - 637.0 *
            ...
            - 1231.0 *
                ( this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_PG98[1]"]]
                + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_PG98[2]"]]
                + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_PG98[3]"]]
                + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_PG98[4]"]]
                + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_PG98[5]"]]
                + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_PG98[6]"]] )

            - 1194.0 *
                ( this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_ES95[1]"]]
                + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_ES95[2]"]]
                + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_ES95[3]"]]
                + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_ES95[4]"]]
                + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_ES95[5]"]]
                + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_ES95[6]"]] )

            - 923.0 *
                ( this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_JPF[1]"]]
                + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_JPF[2]"]] )

            - 907.0 *
                ( this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_AGO_3[1]"]]
                + this->X[scenario_name][n_first_stage_vars + this->second_stage_map["flow_AGO_3[2]"]]
