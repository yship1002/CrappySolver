...
CrudeModel::CrudeModel(BranchingStrategy branching_strategy):STModel() {
    ...
    this->probability = 0.33333333333; //default
    this->perturb={
        {ScenarioNames::SCENARIO1, 0.002033729784573578},
        {ScenarioNames::SCENARIO2, 0.001},
        {ScenarioNames::SCENARIO3, 0.002033729784573578},
        {ScenarioNames::SCENARIO4, 0.001},
        {ScenarioNames::SCENARIO5, 0.002033729784573578}
    };
