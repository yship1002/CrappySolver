...
int main(int argc, char* argv[]) {
    ...
    //CrudeModel: old -23270(5s) -23273.8(3s) -23273.8(5s)
    Ex844Model model(BranchingStrategy::pseudo);


    outsideAlgo CZalgo(&model,0.325313529673937,UBDSolver::IPOPT); // provide UBD for outer layer
    //insideAlgo CZalgo(&model,ScenarioNames::SCENARIO1,-23270,true,UBDSolver:: GUROBI); // provide UBD for outer layer
