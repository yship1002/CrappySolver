...
int main(int argc, char* argv[]) {
    ...
    insideAlgo CZalgo(&model,ScenarioNames::SCENARIO1,-449165,solveFullmodel::yes,UBDSolver:: GUROBI); // provide UBD for outer layer
    ...
    CZalgo.solve(449); // relgap=0.1% tolerance, abs=1
