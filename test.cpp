...
int main(int argc, char* argv[]) {
    ...
    insideAlgo CZalgo(&model,ScenarioNames::SCENARIO1,-22658.2,solveFullmodel::yes,UBDSolver:: GUROBI); // provide UBD for outer layer
    ...
    CZalgo.solve(22); // relgap=0.1% tolerance, abs=1
