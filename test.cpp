...
int main(int argc, char* argv[]) {
    ...
    outsideAlgo CZalgo(&model,-19658.3,UBDSolver::GUROBI); // provide UBD for outer layer
    //insideAlgo CZalgo(&model,ScenarioNames::SCENARIO1,-9,true,UBDSolver:: GUROBI); // provide UBD for outer layer
    ...
    CZalgo.solve(19); // relgap=0.1% tolerance, abs=1
