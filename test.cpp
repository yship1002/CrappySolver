...
int main(int argc, char* argv[]) {
    ...
    //CrudeModel: -19658.3 (121) -19204.1(12121) -18842.4(1212121212)
    ...
    insideAlgo CZalgo(&model,ScenarioNames::SCENARIO1,-18842.4,solveFullmodel::yes,UBDSolver:: IPOPT); // provide UBD for outer layer
    ...
    CZalgo.solve(18); // relgap=0.1% tolerance, abs=1
