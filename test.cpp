...
int main(int argc, char* argv[]) {
    ...
    insideAlgo CZalgo(&model,ScenarioNames::SCENARIO1,-23273.8,solveFullmodel::yes,UBDSolver:: IPOPT); // provide UBD for outer layer
    ...
    CZalgo.solve(23); // relgap=0.1% tolerance, abs=1
