...
int main(int argc, char* argv[]) {
    ...
    insideAlgo CZalgo(&model,ScenarioNames::SCENARIO1,583.156,solveFullmodel::yes,UBDSolver:: IPOPT); // provide UBD for outer layer
    ...
    CZalgo.solve(0.5); // relgap=0.1% tolerance, abs=1
